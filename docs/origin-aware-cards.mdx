...
- ✨ **Origin-aware animations** - Cards expand from their exact position using shared layout animations
- 🎨 **Customizable colors** - Set different colors for collapsed and expanded states
- 🌓 **Dark mode support** - Fully styled for both light and dark themes
- ⌨️ **Keyboard accessible** - Full keyboard navigation with ESC to close
- 📱 **Responsive** - Works seamlessly across all device sizes
- 🎯 **Backdrop blur** - Elegant backdrop overlay with blur effect
- 🔄 **Smooth transitions** - Powered by Framer Motion's layout animations
...
- ✅ **ARIA labels** - Proper `aria-label`, `role`, and `aria-modal` attributes
- ✅ **Keyboard navigation** - Tab through cards, Enter to open, ESC to close
- ✅ **Focus management** - Proper tab index for interactive elements
- ✅ **Semantic HTML** - Uses appropriate heading levels (h1, h2)
